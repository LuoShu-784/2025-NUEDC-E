...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : SOFTUART_TX_Pin */
  GPIO_InitStruct.Pin = SOFTUART_TX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(SOFTUART_TX_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : SOFTUART_RX_Pin */
  GPIO_InitStruct.Pin = SOFTUART_RX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(SOFTUART_RX_GPIO_Port, &GPIO_InitStruct);
